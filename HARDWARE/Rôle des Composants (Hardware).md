...
Processeur (CPU)
Rôle : Interpréter et exécuter les instructions provenant du système d'exploitation et des logiciels.
...
Disque Dur (HDD)
Rôle : Stocker de manière permanente et massive des données sur des plateaux magnétiques rotatifs.

Disque Flash (SSD / NVMe)
...
Carte Graphique (GPU)
Rôle : Traiter les calculs mathématiques complexes liés à l'affichage et générer le signal vidéo vers l'écran.
